...
<head>
<meta charset="UTF-8" />
<title>Invoice ${invoiceNum} — ProtectedPay</title>
<style>
  @page {
    size: A4 landscape;
    margin: 0;
...
<div class="page">
  ...
  <div class="header">
    <div class="brand">
      <img src="${logoUrl}" alt="ProtectedPay logo" />
      <div class="brand-text">
        <h2>ProtectedPay</h2>
        <p>BOT Chain Mainnet · trustless payments</p>
      </div>
    </div>
  ...
  <div class="footer">
    <span>Generated by ProtectedPay · BOT Chain Mainnet</span>
    ${data.explorerUrl
