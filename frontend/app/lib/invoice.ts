...
<head>
<meta charset="UTF-8" />
<title>Invoice ${invoiceNum} — OGPay</title>
<style>
  @page {
    size: A4 landscape;
    margin: 0;
...
<div class="page">
  ...
  <div class="header">
    <div class="brand">
      <img src="${logoUrl}" alt="OGPay logo" />
      <div class="brand-text">
        <h2>OGPay</h2>
        <p>0G Galileo Testnet · trustless payments</p>
      </div>
    </div>
  ...
  <div class="footer">
    <span>Generated by OGPay · 0G Galileo Testnet</span>
    ${data.explorerUrl
