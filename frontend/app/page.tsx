...
const FEATURES = [
  ...
  },
  {
    ...
    title: 'Escrow any ERC-20 token, not just 0G.',
  ...
  },
  {
    ...
    desc: 'No admin key, no upgrade mechanism, no pause function. Every payment is enforced by EVM code on 0G Chain.',
...
const FAQS = [
  {
    ...
    a: 'A protected transfer locks your 0G in a smart contract on 0G Galileo Testnet. The recipient can claim at any time. If they don\'t, you refund yourself — no third party holds the funds, only the contract.',
  },
  {
  ...
  {
    q: 'What is PayBot?',
    a: 'PayBot is an AI assistant built into the dashboard. You can ask it in plain English — "send 1 0G to @alice as escrow" — and it will trigger the wallet confirmation popup instantly. It can also check your history, resolve usernames, and explain any feature.',
  },
  {
    q: 'What is the username registry?',
    a: 'You can register a unique on-chain username (3–30 characters). Others send to @yourname instead of your full address. It works across all OGPay features and is fully on-chain — no off-chain indexer needed.',
  },
  {
    q: 'What token is used for gas?',
    a: 'All transactions use 0G, the native gas token of 0G Galileo Testnet. You need a small amount of 0G in your wallet to pay for gas.',
  },
  {
    q: 'Is OGPay non-custodial?',
    a: 'Yes. OGPay is a set of EVM smart contracts on 0G Chain. No company or individual holds your funds. No admin key, no upgrade mechanism, no pause function. The contract code is open source and auditable by anyone.',
  },
  {
    q: 'Which wallets are supported?',
    a: 'OGPay works with any EVM-compatible wallet: MetaMask, Rainbow, Coinbase Wallet, Trust Wallet, and more. Switch to 0G Galileo Testnet and connect.',
  },
];
    ...
    <main style={{ background: 'var(--background)', minHeight: '100vh', overflowX: 'hidden' }}>
        ...
        titleComponent={
          <div style={{ paddingTop: 0, paddingBottom: 0 }}>
            <p style={{
              ...
              0G Galileo Testnet · EVM Smart Contracts · 0G Gas
            </p>
            <h1 style={{ fontSize: 'clamp(44px, 7vw, 88px)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-3px', marginBottom: 28 }}>
              ...
              <span className="text-gradient" style={{ display: 'block' }}>Built on 0G Chain</span>
            </h1>
            <p style={{ fontSize: 18, lineHeight: 1.7, color: 'var(--foreground-muted)', maxWidth: 520, margin: '0 auto 40px' }}>
              Trustless escrow, group crowdfunding, and batch transfers — secured by EVM smart contracts on 0G Galileo Testnet. No intermediaries. No trust required.
            </p>
      ...
      <section style={{ padding: '64px 0 72px', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 16 }}>
          ...
          <img src="/chain/0G.png" alt="0G Chain"
            style={{ height: 48, width: 'auto', objectFit: 'contain', display: 'block' }}
            onError={e => {
              const el = e.currentTarget as HTMLImageElement;
              el.style.display = 'none';
              const span = document.createElement('span');
              span.textContent = '0G Chain';
      ...
      <section id="how-it-works" style={{ padding: '0 0 96px', borderTop: '1px solid var(--border)' }}>
        <div className="page-container" style={{ paddingTop: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', borderTop: '1px solid var(--border)', borderLeft: '1px solid var(--border)' }}>
            {[
              { n: '01', title: 'Connect Wallet',    desc: 'Install MetaMask, Rainbow, or any EVM wallet. Connect to 0G Galileo Testnet in one click — the app will prompt you to add the chain.' },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center', padding: '80px 0' }}>
            ...
            <div>
              <p style={{ fontSize: 16, color: 'var(--foreground-muted)', lineHeight: 1.75, marginBottom: 32 }}>
                On-chain transparency, post-transfer certainty. Every escrow, group payment, and batch transfer is recorded on 0G Galileo Testnet — visible to anyone, controlled by no one.
              </p>
        ...
        <div className="page-container">
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 20 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <img src="/logo.png" alt="OGPay" style={{ width: 28, height: 28, borderRadius: 8, objectFit: 'cover', display: 'block' }} />
              <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--foreground)' }}>OGPay</span>
              <span style={{ fontSize: 13, color: 'var(--foreground-subtle)', marginLeft: 4 }}>· EVM · 0G Galileo Testnet</span>
            </div>
